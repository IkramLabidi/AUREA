        ...
        <div className="bg-[#0b111f]" id="whitegold">  
            <div className="flex flex-col-reverse lg:flex-row items-center justify-center gap-8 px-4 sm:px-10 lg:px-20 py-5">
                ...
                <div className="flex flex-col gap-4 max-w-lg text-center lg:text-left">
                    ...
                    <p className="text-gray-400 text-sm sm:text-base">Our white gold collection combines modern design with traditional craftsmanship. Each sterling silver piece is meticulously crafted to provide a contemporary look that complements any style.</p>
                </div>
            </div>
