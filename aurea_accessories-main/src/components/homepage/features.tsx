...
export function Features(){
    ...
    return(
        <div className="flex flex-col items-center gap-10 p-6 sm:p-10 bg-gradient-to-b from-black to-amber-900/20 w-full"> 
            <div className="flex flex-col gap-3 max-w-2xl text-center">
                <h1 className="text-amber-500 text-2xl sm:text-3xl font-serif font-bold">Featured Pieces</h1>
                <p className="text-gray-400 text-sm sm:text-base">Discover our most coveted accessories, handcrafted with precision and passion.</p>
            </div>
            ...
            <Link to={"/collections/herosection"}>
                <button className="bg-amber-500 py-3 px-6 rounded-md text-black font-medium hover:bg-amber-400 transition-all duration-300 hover:cursor-pointer">View All Products</button>
            </Link>
