...
export function Card({title, desc, pieces}: CardProps){
    ...
    return(
        <div className="rounded-xl py-10 px-6 bg-gradient-to-b from-black via-gray-900 to-gray-700 hover:scale-105 transition-transform duration-300 shadow-lg shadow-amber-500/20 w-full max-w-xs mx-auto">
  ...
  <button
    className="mt-6 w-full border border-amber-500 text-amber-500 rounded-lg py-2.5 px-6 font-medium hover:bg-amber-500 hover:text-black transition-all duration-300 shadow-sm"
