...
export function Features(){
    ...
    return(
        <div className="flex flex-col items-center gap-10 px-4 sm:px-10 lg:px-20 py-10" id="newArrivals"> 

            <div className="flex flex-col gap-5 text-center max-w-2xl">
                <h1 className="text-3xl sm:text-4xl text-amber-500 font-serif font-bold">Latest Additions</h1>
                <p className="text-gray-400 text-sm sm:text-base">Be among the first to experience our newest masterpieces, fresh from our artisan workshop.</p>
            </div>
